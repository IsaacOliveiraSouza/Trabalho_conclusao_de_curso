...
class Banco{
	...
	function inserirSupervisor($nome, $email, $telefone, $cargo){
        ...
        $stmt = $this->con->prepare("insert into supervisor(telefone, email, nome, cargo) values (?,?,?,?);");
    ...
    function inserirContrato($matricula,  $cnpj, $dataInicio, $cargaHorariaDia, $dataFim, $supervisor, $apolice){
        $stmt = $this->con->prepare("insert into contrato(matricula_aluno, cnpj_empresa, data_inicio, carga_horaria_dia, data_fim_contrato, codsupervisor, apolice) values (?,?,?,?,?,?,?);");
